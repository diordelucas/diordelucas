...
🏢 Desenvolvedor @ **Suco Prat's** & Sócio-Desenvolvedor @ **MPG Sistemas** | 🎓 Sistemas de Informação (UNIPAR)  
📍 Paranavaí – PR, Brasil
...
- Processamento de contagens microbiológicas em notação científica (ex. 4<10)
- Regras de conversão para Metabase e alertas de CT alto e patógeno
- Documentação técnica detalhada e persistência em banco de dados
- Alimenta dashboards Metabase com dados de laboratório

#### 🔧 Integrações & Automações (n8n)

- **Integração PIMS MC ↔ CTA Smart**: Pipeline de processamento de registros de abastecimento
- **Automação WhatsApp → GLPI**: Criação automática de chamados de suporte
- **Pipelines de dados complexos**: Orquestração e tratamento de exceções em ambientes críticos

---

### **MPG Sistemas** | Sócio-Desenvolvedor
Parceria em desenvolvimento de soluções web e integração de sistemas. Atuação como igual junto aos sócios Matheus e Pedro no desenvolvimento de projetos de software para clientes.

#### 🏗️ Arquitetura & Backend Java/Spring Boot

- Design e desenvolvimento de APIs RESTful escaláveis
- Serviços de negócio e persistência em dados (PostgreSQL, MySQL)
- Integração de sistemas heterogêneos e tratamento de exceções
- Implementação de fallbacks e soluções robustas para ambientes críticos

#### 📊 Projetos

- **Sistema Revisional Bancário Web**: Análise de contratos com Java/Spring Boot (migração em curso)
- Desenvolvimento customizado conforme demandas de clientes
...
### 🍽️ [SIGREST – Sistema de Gerenciamento de Restaurante](https://github.com/diordelucas/sigrest)
Sistema completo de gerenciamento com módulos de pedidos, estoque, clientes e controle financeiro.
...
- Conhecimentos em arquitetura de software, design patterns, engenharia de dados
